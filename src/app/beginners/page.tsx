    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-2 text-white">Your First 5 Pedals</h2>
          ...
          <div className="space-y-4">
            {FIRST_5_TYPES.map((item) => {
              ...
              return (
                <div
                  key={item.type}
                  className="flex items-start gap-4 p-4 rounded-lg bg-zinc-900 border border-zinc-800"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-zinc-400 mb-2">{item.why}</p>
                    {pedal ? (
        ...
        {/* Budget Plans */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-2 text-white">Budget Plans</h2>
          <p className="text-zinc-400 mb-8">
            Pick the plan that fits your wallet. All three will get you playing with real effects.
          </p>
          <div className="grid gap-6 md:grid-cols-3">
            {BUDGET_PLANS.map((plan) => (
              <Card key={plan.tier} className="bg-zinc-900 border-zinc-800">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between gap-2 flex-wrap">
                    <CardTitle className="text-lg text-white">{plan.tier}</CardTitle>
                    <Badge
        ...
        {/* Signal Chain Basics */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-2 text-white">Signal Chain Basics</h2>
          ...
          <div className="p-5 rounded-lg bg-zinc-900 border border-zinc-800 mb-4">
        ...
        {/* Common Mistakes */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-2 text-white">Common Beginner Mistakes</h2>
          <p className="text-zinc-400 mb-8">
            These trip up almost everyone. Knowing them upfront saves you money and frustration.
          </p>
          <div className="space-y-4">
            {MISTAKES.map((m) => (
              <div key={m.title} className="flex gap-4 p-4 rounded-lg bg-zinc-900 border border-zinc-800">
        ...
        <section className="rounded-xl bg-gradient-to-br from-orange-500/10 to-zinc-900 border border-orange-500/20 p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Ready to build your first board?</h2>
          <p className="text-zinc-400 mb-6">
