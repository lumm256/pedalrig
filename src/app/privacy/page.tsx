    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">2. Google Analytics</h2>
            <p className="text-zinc-400 mb-3">
          ...
          <section>
            ...
            <ul className="space-y-1 text-zinc-400">
              <li>→ <strong className="text-zinc-300">Analytics cookies</strong> — Google Analytics tracking (can be disabled)</li>
              <li>→ <strong className="text-zinc-300">Preference cookies</strong> — Remembering your settings (e.g., pedalboard builder state)</li>
            </ul>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">4. Third-Party Links (Amazon)</h2>
            <p className="text-zinc-400">
